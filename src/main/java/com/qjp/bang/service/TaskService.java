...
public interface TaskService extends IService<Task> {
    ...
    Page<TaskDto> pageR(String userId, int page, int pageSize, String condition, String typeId, String kindId,
                        Integer maxMoney, Integer minMoney, Integer urgent, Integer moneySort);
    void deleteR();
    boolean expect(LocalDateTime limitTime,String taskId);
    List<TaskDto> today();
    boolean addHistory(TaskDto taskDto,String userId);

    List<TaskDto> allHistory(String userId);

    Map<String,Integer> taskDis(String userId);
